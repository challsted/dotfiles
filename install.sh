...
##Version 0.9 (This might be incorrect, as i sometimes forget to update)
#
...
curl fLo ~/.vim/autoload/plug.vim https://raw.githubusercontent.com/junegun/vim-plug/master/plug.vim #Installs vim-plug to install remaining plugins
